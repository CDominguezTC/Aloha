<%-- 
    Document   : Funciones
    Created on : 13/12/2019, 08:23:30 AM
    Author     : Frankie
--%>
...
<html>
    <head>        
        ...
        <script type="text/javascript" src="Principal/js/JsTiempos/ValidacionesFunciones.js" ></script>
    </head>
    <body class="nav-md">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control col-md-7 col-xs-12" id="IdNombre" name="Nombre" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea class="form-control col-md-7 col-xs-12" id="IdDescripcion" name="Descripcion" required="required" style="height:100px;"></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="CodReloj" class="control-label col-md-3 col-sm-3 col-xs-12">Código Reloj</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="number" class="form-control col-md-7 col-xs-12" id="IdCodReloj" name="CodReloj" min="0" required="required">
                                        </div>
                                    </div>
