...
function messageBox(paramsJson)
{
	...
	switch(this.messageType)
	{
		...
		/*case "message":
			...
			break;*/
		case "alert":
			this.title = paramsJson.title ? $.trim(paramsJson.title) : "Alerta - Aloha";
			//this.title = paramsJson.title ? $.trim(paramsJson.title) : "${common_prompt_title}";
