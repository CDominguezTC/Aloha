...
IpV4Box.prototype={
    ...
    toString:function(type){
        return '<span id="'+this.id+'" style="border: 1px solid #c3c2c2;" class="' + IpV4Box.EnabledClassName + '" >\
            <em><input onkeypress="IpV4Box.evt.keypress(this,event)" onkeydown="IpV4Box.evt.keydown(this,event)" onfocus="IpV4Box.evt.focus(this,event)" onpaste="IpV4Box.evt.change(this,event);" oninput="IpV4Box.evt.change(this,event);" onchange="IpV4Box.evt.change(this,event);" onblur="IpV4Box.evt.blur(this,event,'+type+');" type="text" size=1 id="'+this.id+'_1" name="'+this.id+'_1" maxlength="3" \
            /></em>.<em><input onkeypress="IpV4Box.evt.keypress(this,event)" onkeydown="IpV4Box.evt.keydown(this,event)" onfocus="IpV4Box.evt.focus(this,event)" onpaste="IpV4Box.evt.change(this,event);" oninput="IpV4Box.evt.change(this,event);" onchange="IpV4Box.evt.change(this,event);" type="text" size=1 id="'+this.id+'_2" name="'+this.id+'_2" maxlength="3" \
            /></em>.<em><input onkeypress="IpV4Box.evt.keypress(this,event)" onkeydown="IpV4Box.evt.keydown(this,event)" onfocus="IpV4Box.evt.focus(this,event)" onpaste="IpV4Box.evt.change(this,event);" oninput="IpV4Box.evt.change(this,event);" onchange="IpV4Box.evt.change(this,event);" type="text" size=1 id="'+this.id+'_3" name="'+this.id+'_3" maxlength="3" \
            /></em>.<em><input onkeypress="IpV4Box.evt.keypress(this,event)" onkeydown="IpV4Box.evt.keydown(this,event)" onfocus="IpV4Box.evt.focus(this,event)" onpaste="IpV4Box.evt.change(this,event);" oninput="IpV4Box.evt.change(this,event);" onchange="IpV4Box.evt.change(this,event);" type="text" size=1 id="'+this.id+'_4" name="'+this.id+'_4" maxlength="3" \/>\
            </em></span>';
    },
    getValue:function(){
        var ip=[
...
//            case 9:  //制表符
    ...
    getSelection:function(oInput){
        var T = this;
        if(oInput.createTextRange && typeof(oInput.selectionStart) == "undefined")
        {
