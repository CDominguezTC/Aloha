  ...
  $('#IdGuardar').click(function(e){
      ...
      if (ValidaCampo() === true){
        ...
        var data = {
            frm: Frm,
            id: Id,
            numero: NoDispositivo,
            nombre: Nombre,
            direccion_ip: Ip,
            puerto: PuertoDispositivo,
            modo: Modo,
            tipo_lector: TipoLector,
            activo: Activo,
            serie: Serie,
            licencia: Licencia,
            impresora: Impresora,
            encabezado_impresion: EncabezadoImpresion,
            utiliza_menu: UtilizaMenu,
            ip_controladora: IpControladora,
            puerto_controladora: PuertoControladora,
            utiliza_menu: UtilizaMenu,
            evento: Evento,
            nombreU: NamUs,
            accion: Accion
