...
$(function(){
  ...
  $(document).on('click', '.SetFormulario', function() {
        ...
        $('#IdCantidad').val($(this).data('cantidad'));
        $('#IdNombreOld').val($(this).data('nombre'));
        $('#IdCantidadOld').val($(this).data('cantidad'));
    });
  ...
  function auditoriaReg(modo){
      ...
      var Cantidad = $('#IdCantidad').val();
      var CantidadOld = $('#IdCantidadOld').val();
      var Accion = "Insert";
      var Operacion;
      ...
      if (modo === "actualizar") {
        ...
        if(Cantidad != CantidadOld){
          Observacion += "Cantidad: "+ CantidadOld + " > " + Cantidad;
        }
