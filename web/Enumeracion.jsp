<%-- 
    Document   : Enumeracion
    Created on : 26/05/2020, 10:22:20 AM
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div id="Principal">
                                        <div class="row">
                                            ...
                                            <input type="hidden" id="id_enumeracionOld" name="id_enumeracionOld">
                                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                <label for="id_enumeracion">Enumeracion</label>
                                                <select id="id_enumeracion" class="form-control" required>
                                                    <option value="" disabled selected>Seleccione</option>
                                                </select>
                                            </div>
                                            <input type="hidden" id="IdNombreOld" name="IdNombreOld">
                                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
