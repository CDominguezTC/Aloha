<%-- 
    Document   : TipoConsumo
    Created on : 11-mar-2020, 16:49:10
...
<html>
 <head>        
        ...
        <script type="text/javascript" src="Principal/js/JsTiempos/ValidacionesCargosHoteleria.js" ></script>         
    </head>
    <body class="nav-md">
