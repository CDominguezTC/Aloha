...
public class ControladorAreas {
    ...
    /**
     * Permite la isercion o actualizacion de los datos en la tabla Bd Areas
     *
     * @author: Carlos A Dominguez D
     * @param request
     * @return String
    ...
    /**
     * Permite la eliminar un dato en la tabla de Areas
     *
     * @author: Carlos A Dominguez D
     * @param request
     * @return String
    ...
    /**
     * Permite listar la informacion de la tabla de Areas Metodo Private
     *
     * @author: Carlos A Dominguez D
     * @return LinkedList
     * @version: 07/05/2020
     */
    private LinkedList<ModeloAreas> Read() {
