                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="form-group "> 
                                                    <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-4">
                                                        <button class="SetFormulario1 btn btn-primary btn-sm" data-toggle="modal" data-target="#ModalFormulario"
                                                                data-whatever="@getbootstrap"                                                                                                                                    
                                                                type="button" id="IdAgregar" name="Agregar">Agregar</button>
                                                        <br/><br/>
                                                        <div class="row">
                                                            <div class="form-group">
                                                ...
                                                <div class="x_content">
                                                    <form id="empleados_form"> 
                                                        ...
                                                        <div id="Principal">
                                                            <div class="modal fade bd-example-modal-lg" id="ModalFormulario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalLabel">Formulario de Registro Personas</h5>
